...
var DragulaService = (function () {
    ...
    DragulaService.prototype.handleModels = function (name, drake) {
        ...
        drake.on('drop', function (dropElm, target, source) {
            ...
            sourceModel = drake.models[drake.containers.indexOf(source)];
            sourceParent = drake.parents[drake.containers.indexOf(source)];
            // console.log('DROP');
            // console.log(sourceModel);
            if (target === source) {
            ...
            _this.dropModel.emit([name, dropElm, target, source, sourceModel, targetModel, sourceParent, targetParent]);
        });
    };
