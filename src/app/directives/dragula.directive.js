...
var Dragula = (function () {
        ...
        var checkModel = function () {
            if (_this.dragulaModel) {
                if (_this.drake.models) {
                    ...
                    _this.drake.parents.push(_this.parent);
                }
                else {
                    _this.drake.models = [_this.dragulaModel];
                    _this.drake.parents = [_this.parent];
                }
            }
        };
        if (bag) {
    ...
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Object)
    ], Dragula.prototype, "parent", void 0);
    Dragula = __decorate([
        core_1.Directive({
            selector: '[dragula]'
        }), 
        __metadata('design:paramtypes', [(typeof (_a = typeof core_1.ElementRef !== 'undefined' && core_1.ElementRef) === 'function' && _a) || Object, dragula_provider_1.DragulaService])
    ], Dragula);
    return Dragula;
    var _a;
}());
